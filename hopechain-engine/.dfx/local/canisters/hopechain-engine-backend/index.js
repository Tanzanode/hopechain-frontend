 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hopechain-engine-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hopechain-engine-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hopechain-engine-backend.did.js")._SERVICE>}
 */
export const hopechain_engine_backend = createActor(canisterId);
